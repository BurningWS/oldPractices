	...
	<div id="content" class="white">
		...
		<div class="bloc">
			<div class="title" style="font-size: xx-large; top: 0px; left: 0px">
				<span class="style7">添加课程信息</span><br />
			</div>
			<div class="content">
				<table>
					<thead>
					...
					<tbody>
						<form action="addCourse" method="post">
							<tr>
								<td class="style2">课程名称</td>
								<td class="style2"><input name="c.name" type="text" />
							</tr>
						<tr>
							<td class="style2" style="width:140px;">学期</td>
							<td><select name="semid">
									<option value="0">-请选择-</option>
									<c:forEach var="s" items="${list }">
										<option value="${s.id }">${s.date }</option>
									</c:forEach>
							</select></td>
						</tr>
						<tr>
							<td class="style2">学时</td>
							<td class="style2"><input name="c.weeks" type="text" />
						</tr>
						<tr>
