jQuery(function($){
   ...
   $('.notif .close').click(function(){
     ...
     * Tabs 
     */
    var anchor = window.location.hash;  // On r茅cup l'ancre dans l'url http://......#ancre
    $('.tabs').each(function(){
        var current = null;             // Permet de connaitre l'茅l茅ment courant
        ...
        $(current).siblings().hide();                               // On masque les 茅l茅ments
        $(this).find('a').click(function(){
           var link = $(this).attr('href'); 
           // On a cliqu茅 sur l'茅l茅ment d茅ja active
           if(link == current){
               return false;
           }else{
