...
<%
	...
	List<Major> list = bsi.getAllMajors();
	...
	<div id="content" class="white">
		...
		<div class="bloc">
			<div class="title" style="font-size: xx-large; top: 0px; left: 0px">
				<span class="style7">添加学生信息</span><br />
			</div>
			<div class="content">
				<table>
					<thead>
					...
					<tbody>
						...
						<tr>
							...
							<td class="style2"><input name="name" type="text" />
						</tr>
						<tr>
							<td class="style2">性别</td>
							<td class="style2"><input id="Radio1" checked="true"
								name="male" type="radio" value="true" />男&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input id="Radio2" name="male" type="radio" value="false" />女
							</td>
						</tr>
						<tr>
							<td class="style2" style="width:140px;">学号</td>
							<td><input id="Snumber" name="id" type="text" /></td>
						</tr>
						<tr>
							<td class="style2" style="width:140px;">专业</td>
							<td><select name="mid">
						...
						<tr>
							...
							<td class="style2"><input name="idcard" type="text" />
						</tr>
						<tr>
							<td class="style2">密码</td>
							<td class="style2"><input name="password" type="text" />
						</tr>
						<tr>
