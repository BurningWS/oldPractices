...
vy=tf.syear.options[tf.syear.selectedIndex].value;
 ...
 { window.alert("锲为【璇蜂粠2006骞?9链?9镞ュ紑濮?);}
 else    {
...
<div class="_bd_ext_tip" style="visibility: hidden;"><span class="_bd_ext_search">鐧惧害涓€涓?/span><span class="_bd_ext_open">镓揿紑阈炬帴</span><span class="_bd_ext_copy">澶嶅埗</span></div></body></html>